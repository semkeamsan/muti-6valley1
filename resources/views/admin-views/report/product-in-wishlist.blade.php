        ...
        <div class="page-header">
            ...
            <div class="js-nav-scroller hs-nav-scroller-horizontal">
                <ul class="nav nav-tabs page-header-tabs" id="projectsTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" href="javascript:">{{\App\CPU\translate('Product in wishlist report')}} ({{ $products->total() }})</a>
                    </li>
                </ul>
            </div>
            <!-- End Nav -->
                            ...
                            <div class="col-md-9 mt-2 mt-sm-0">
                                <form style="width: 100%;" action="" id="form-data" method="get">
                                    <div class="row text-{{Session::get('direction') === "rtl" ? 'right' : 'left'}}">
                                        ...
                                        <div class="col-md-2 mt-2">
                                            <button type="submit" onclick="formUrlChange(this)" data-action="{{ route('admin.stock.wishlist-product-export') }}" class="btn btn-success btn-block">
