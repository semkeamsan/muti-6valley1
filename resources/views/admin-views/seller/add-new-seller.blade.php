...
@section('content')
    <div class="content container-fluid main-card rtl"
                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="{{route('shop.apply')}}" method="post"
                                        ...
                                        <input type="hidden" name="seller_index_url"
                                               value="{{ route('admin.sellers.seller-list') }}">
                                        ...
                                        <input type="hidden" name="is_phone_verified" value="true">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6"><small class="text-danger invisible">( * )</small>
                                                <input type="tel" class="form-control form-control-user"
                                                       id="phone" name="phone[main]"
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-6 mb-3 mb-sm-0 mt-4">
                                                <input type="password" class="form-control form-control-user"
                                                       minlength="6" id="exampleInputPassword" name="password"
