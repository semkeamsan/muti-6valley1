    ...
    <div class="container py-4 py-lg-5 my-4">
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-10">
                ...
                <p class="font-size-md">{{\App\CPU\translate('Change your password in two easy steps. This helps to keep your new password secure')}}
                    .</p>
                <ol class="list-unstyled font-size-md">
                    <li><span
                            class="text-primary mr-2">{{\App\CPU\translate('1')}}.</span>{{\App\CPU\translate('New Password')}}
                        .
                    </li>
                    <li><span
                            class="text-primary mr-2">{{\App\CPU\translate('2')}}.</span>{{\App\CPU\translate('Confirm Password')}}
                        .
                    </li>
                </ol>
                    ...
                    <form class="card-body needs-validation" novalidate method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <div class="password-toggle">
                                ...
                                <div class="invalid-feedback">{{\App\CPU\translate('Please provide valid password')}}.
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
