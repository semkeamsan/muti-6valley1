                        ...
                        <form id="form-id" action="{{route('seller.auth.login')}}" method="post">
                            ...
                            <div class="text-center">
                                <div class="mb-5">
                                    ...
                                    <center><h1
                                            class="h4 text-gray-900 mb-4">{{\App\CPU\translate('welcome_back_to_seller_login')}}</h1>
                                    </center>
                                </div>
                            ...
                            <div class="js-form-message form-group">
                                ...
                                <input type="tel" class="form-control form-control-lg" name="phone[main]" id="phone"
                                       style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};"
                                       required>
                            </div>
                            <!-- End Form Group -->
