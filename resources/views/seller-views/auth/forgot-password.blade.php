        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-md-10">
                ...
                <ol class="list-unstyled font-size-md">
                    <li><span
                            class="text-primary mr-2">1.</span>{{\App\CPU\translate('Fill in your phone number below')}}
                        .
                    </li>
                    <li><span
                            class="text-primary mr-2">2.</span>{{\App\CPU\translate('We will send you a temporary code')}}
                        .
                    </li>
                ...
                <div class="card py-2 mt-4">
                    <form class="card-body needs-validation" action="{{route('seller.auth.reset-password-request')}}"
                          method="post">
                        @csrf
                        <div class="form-group">
                            <label for="recover-phone">{{\App\CPU\translate('Enter your phone number')}}</label>
                            <div class="mb-4">
                                <input class="form-control" type="phone" name="phone[main]" id="recover-phone" required>
                            </div>
                        </div>
