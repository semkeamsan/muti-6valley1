                    ...
                    <form class="card-body needs-validation" novalidate method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <div class="password-toggle">
                                <input class="form-control" name="password" type="password" id="si-password" placeholder="{{\App\CPU\translate('password')}}"
                                       required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="password-toggle">
                                <input class="form-control" name="confirm_password" type="password" id="si-password" placeholder="{{\App\CPU\translate('repeat_password')}}"
                                       required>
                                <label class="password-toggle-btn">
