...
Route::group(['namespace' => 'api\v1', 'prefix' => 'v1', 'as' => 'api.v1.', 'middleware' => ['api_lang']], function () {

    Route::get('check-user', 'CustomerController@check_user')->name('check_user');

    Route::any('/auth/check-phone', 'CustomerController@check_phone');

    Route::group(['prefix' => 'auth', 'namespace' => 'auth'], function () {
        Route::post('register', 'PassportAuthController@register');
        Route::post('login', 'PassportAuthController@login');

        Route::post('verify-token', 'PassportAuthController@verify_token');
    ...
    Route::group(['prefix' => 'customer', 'middleware' => 'auth:api'], function () {
        ...
        Route::group(['prefix' => 'order'], function () {
            ...
            Route::group(['prefix' => 'payment-images'], function () {
                Route::get('/', 'PaymentImageController@index');
                Route::post('/', 'PaymentImageController@store');
            });
        });
        // Chatting
    ...
    Route::group(['prefix' => 'uploads',], function () {
        Route::post('image', 'FileUploadController@upload_temp_image')->name('temp_image');
    });
